...
export interface NarrativeArcEntry {
  slide_number: number;
  title: string;
  visual_need?: string;    // natural-language description of what visual this slide needs (Pass 2 matches to figures)
...
export interface Session {
  ...
  /** Narrative arc from Pass 1 planning — persisted for slide audit */
  narrativeArc?: NarrativeArcEntry[];
  /** Per-slide audit results — persisted so audits survive session reload */
